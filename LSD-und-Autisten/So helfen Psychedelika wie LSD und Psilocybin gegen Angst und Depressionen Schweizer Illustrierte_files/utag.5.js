...
//tealium universal tag - utag.sender.20067 ut4.0.202109271305, Copyright 2021 Tealium.com Inc. All Rights Reserved.
try{
  (function(id, loader) {
    var u = {"id" : id};
    ...
    u.send = function (a, b) {
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        u.data = {
          ...
          "qs_delim" : "?" || "?",
          "tag_type" : "img",
          "base_url" : "https://ad.doubleclick.net/ddm/activity/src=9245961;type=gener0;cat=si-vi0;u1=@@dom.pathname@@;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=;npa=;ord=@@random_value@@",
          "secure_base_url" : "",
          "static_params" : "",
          "cachebust" : "disabled",
          "cachevar" : "" || "_rnd",
  ...
  }("5", "rasch.schweizer-illustrierte.ch"));
} catch (error) {
  utag.DB(error);
}

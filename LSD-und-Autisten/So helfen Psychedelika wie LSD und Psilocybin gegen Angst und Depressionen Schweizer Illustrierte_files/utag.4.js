...
//tealium universal tag - utag.sender.6026 ut4.0.202202221310, Copyright 2022 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {"id" : id};
    ...
    u.process_AM_data = function (_data) {
      ...
      u.map={"event_category:Mailchimp":"lead","event_category:piano checkout_complete":"CheckoutComplete","event_category:form":"FormSubmit","event_category:piano start_checkout":"StartCheckout","event_action":"CheckoutComplete.product_id","piano_conversion_value":"CheckoutComplete.conversion_value,CheckoutComplete.value","event_label":"FormSubmit.form_name"};
  u.extend=[];
  ...
  }("4", "rasch.schweizer-illustrierte.ch"));
} catch (error) {
  utag.DB(error);
}

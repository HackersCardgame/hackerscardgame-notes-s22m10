//~~tv:7110.20190129
//~~tc: Update Clear Global Vars to clear dimensions and metrics on view/link events
//~~tc: Support false boolean values for the set command
//~~tc: Add support for Google AMP Client ID
//~~tc: Updating to use u.data.tid (when populated) to override u.data.account.
...
//tealium universal tag - utag.sender.7110 ut4.0.202204201520, Copyright 2022 Tealium.com Inc. All Rights Reserved.
  ...
  (function(id, loader) {
    ...
    u.initTracker = function() {
      ...
      if (!u.created) {
        ...
        for (f = 0; f < u.data.account.length; f++) {
          ...
          //activate Google Optimize if google_optimize_container_id parameter is mapped
          if (u.data.google_optimize_container_id && typeof(u.data.google_optimize_container_id.startsWith) === "function" && u.data.google_optimize_container_id.startsWith("GTM-")) {u.o(c.name+".require", u.data.google_optimize_container_id);}
        }
    ...
    u.setGlobalProperties = function (data, reset, custom_property) {
      ...
      if ( data.clear_global_vars === "true" ) {
        for (key in u.map) {
            if (u.map[key].match(/dimension|metric/) && typeof data[key] === "undefined") {
    ...
    window.utag.tagsettings.gua.trackernames =  window.utag.tagsettings.gua.trackernames  || 0;
      ...
      u.map={"page_with_query":"page","cms_page_title":"title","event_category":"eventCategory","event_action":"eventAction","event_label":"eventLabel","event_value":"eventValue","event_non_interaction":"nonInteraction","cms_page_id":"pageview-dimension26,link-dimension26","cms_page_type":"pageview-dimension33,link-dimension33","cms_article_type":"pageview-dimension34,link-dimension34","cms_authors":"pageview-dimension8,link-dimension8","cms_change_date":"pageview-dimension32,link-dimension32","cms_channel":"pageview-dimension1,link-dimension1","cms_create_date":"pageview-dimension11,link-dimension11","cms_keywords":"pageview-dimension21,link-dimension21","hit_type":"pageview-dimension31","gallery_current_image":"pageview-dimension27","gallery_total_images":"pageview-dimension28","gallery_paragraph":"pageview-dimension29","gallery_direction":"pageview-dimension30","fullscreen_gallery":"pageview-dimension35","video_load":"link-metric11","video_start":"link-metric12","video_completion":"link-metric13","video_view_50_percent":"link-metric14","video_percent_played":"link-metric15","video_seconds_played":"link-metric16","cms_channel_sponsor":"pageview-dimension37","sponsor_impression":"pageview-metric18","_sm_2_30":"google_optimize_container_id","cms_preferredUri":"pageview-dimension40,link-dimension40","cms_main_channel":"pageview-dimension41,link-dimension41","pwa_standalone_mode":"dimension42","cms_target_page_type":"link-dimension43","cms_target_page_sponsor":"link-dimension44","cms_target_preferredUri":"link-dimension45","cms_login_status":"dimension47","cms_user_id":"dimension46","piano_experience_id":"link-dimension48","cp._pc_dso":"pageview-dimension49,link-dimension49","cp._pc_ocount":"pageview-dimension50,link-dimension50","ec_action":"enh_action","checkout_step":"enh_checkout_step","order_id":"order_id","order_total":"revenue","product_id":"product_id","product_quantity":"product_quantity","product_price":"product_unit_price","promo_id":"enh_promo_id","promo_name":"enh_promo_name","promo_creative":"enh_promo_creative","promo_position":"enh_promo_position","product_impression_id":"enh_impression_id","product_impression_list":"enh_impression_list","product_impression_position":"enh_impression_position","product_brand":"product_brand","product_variant":"product_variant","time_to_first_byte":"link-metric19","time_to_first_byte_count":"link-metric20","first_paint":"link-metric21","first_paint_count":"link-metric22","first_contentful_paint":"link-metric23","first_contentful_paint_count":"link-metric24","largest_contentful_paint":"link-metric25","largest_contentful_paint_count":"link-metric26","comment_type":"link-dimension51","cms_article_source":"pageview-dimension52,link-dimension52","cms_print_article":"pageview-dimension53,link-dimension53","cms_publication_date":"pageview-dimension54,link-dimension54","cms_restriction_status":"pageview-dimension55,link-dimension55","a_config":"pageview-dimension56","a_slots":"pageview-dimension57"};
  u.extend=[function(a,b){
try{b['_sm_2_30']="GTM-WRHZXB5";}catch(e){utag.DB(e);}
},
function(a,b){ try{ if(1){try{b['cms_authors']=b.cms_authors.join(";");}catch(e){};try{b['cms_keywords']=b.cms_keywords.join(";");}catch(e){};try{b['fullscreen_gallery']=b["dom.hash"].startsWith("image-") ? 1 : 0;}catch(e){};try{b['sponsor_impression']=Math.round(1000 / b.cms_channel_sponsor.length);}catch(e){};try{b['cms_channel_sponsor']=b.cms_channel_sponsor.join(";");}catch(e){};try{b['page_with_query']=b["dom.query_string"] ? b["dom.pathname"] + "?" + b["dom.query_string"] : b["dom.pathname"]}catch(e){};try{b['cms_page_title']=b.cms_page_title ? b.cms_page_title : b["dom.title"];}catch(e){}} } catch(e){ utag.DB(e); }  },
function(a,b){ try{ if(b['event_name']=='search_suggestions_click'){try{b['page_with_query']="/search?searchterm=" + b.site_search_term + "&searchtype=suggestion_click";}catch(e){}} } catch(e){ utag.DB(e); }  }];
    ...
    u.send = function(a, b) {
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        (function () {
          ...
          //This is required by Google. Current timestamp
          u.o.l = 1 * new Date();
        })();
  ...
  }('2', 'rasch.schweizer-illustrierte.ch'));
} catch (error) {
  utag.DB(error);
}

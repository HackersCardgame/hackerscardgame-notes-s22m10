...
//tealium universal tag - utag.sender.7142 ut4.0.202210140945, Copyright 2022 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {
      "id" : id
    ...
    /* eslint-disable-next-line */
      u.map={"cms_page_type":"all_events.cms_page_type","tealium_event:view":"page_view","event_name:set_user_id":"set_user_id","event_label":"set_user_id.event_label"};
  u.extend=[];
        ...
        for (i = 0; i < u.data.event_queue.length; i++) {
          ...
          Object.keys(u.map).forEach(function(mapping_from) {
            if (
              ...
              var mapping_to = u.map[mapping_from].substring(event_name.length + 1);
  ...
  }("15", "rasch.schweizer-illustrierte.ch"));
} catch (error) {
  utag.DB(error);
}

...
//tealium universal tag - utag.sender.7132 ut4.0.202109271305, Copyright 2021 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {"id" : id};
  ...
  }("7", "rasch.schweizer-illustrierte.ch"));
} catch (error) {
  utag.DB(error);
}

(function($){
    var siJsHost = (('https:' === document.location.protocol) ? 'https://' : 'https://');
    var host=siJsHost+'www.socialintents.com/';var intentUrl= host+"chatWidget.1.0.jsp";
    ...
    $.fn.tabSlideOut = function(callerSettings) {
        ...
        if (settings_chat.tabType=='circle'){
            ...
            html+=".siNotify {font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;display:none;background: #ff1a00;background: -moz-linear-gradient(top,#ff1a00 0,#ff1a00 100%);background: -webkit-linear-gradient(top,#ff1a00 0,#ff1a00 100%);background: linear-gradient(to bottom,#ff1a00 0,#ff1a00 100%);border: 2px solid #fff;border-radius: 50%;box-shadow: 0 1px 1px 0 rgba(0,0,0,.5);color: #fff;filter: progid:dximagetransform.microsoft.gradient(startColorstr='#ff1a00', endColorstr='#ff1a00', GradientType=0);font-size: 11px;font-weight: 700;height: 18px;padding-top:0px;position: absolute;right: -2px;text-align: center;top: 0px;width: 18px;}";
            ...
            html+="#si-wrapper .silc-btn-button.silc-btn-button-color {background-color: #00aeef;}#si-wrapper .silc-btn-button, #si-wrapper  {box-shadow: 0 6px 12px 0 rgba(0, 0, 0, 0.2);}#si-wrapper .silc-btn-button {background-position: 50% center;bottom: 0;right: 0;cursor: pointer;background-repeat: no-repeat;background-size: 27px;border-radius: 50%;height: 55px;width: 55px;position: absolute;}";
            ...
            if (settings_chat.tabColor && settings_chat.tabColor.length>0){
                ...
                if ("#00AEEF" != settings_chat.tabColor){
                    $('.silc-btn-button').css({ 
            ...
            html+=".siNoScroll {position: fixed !important ;overflow: hidden !important;width: 100% !important;height: 100% !important;}";
            html+=".siNotify {font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;display:none;background: #ff1a00;background: -moz-linear-gradient(top,#ff1a00 0,#ff1a00 100%);background: -webkit-linear-gradient(top,#ff1a00 0,#ff1a00 100%);background: linear-gradient(to bottom,#ff1a00 0,#ff1a00 100%);border: 2px solid #fff;border-radius: 50%;box-shadow: 0 1px 1px 0 rgba(0,0,0,.5);color: #fff;filter: progid:dximagetransform.microsoft.gradient(startColorstr='#ff1a00', endColorstr='#ff1a00', GradientType=0);font-size: 11px;font-weight: 700;height: 18px;padding-top: 1px;position: absolute;right: -8px;text-align: center;top: -6px;width: 18px;}";
